<x-crud-layout>
    ...
    <form action="{{ route('activities.update', $activity) }}" method="POST" class="mt-2"
        ...
        <div class="mt-2">
            ...
            <x-input id="image" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-black-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm block mt-1 w-full input-bg-white" type="file" name="image" :value="old('image')" required
                autocomplete="image" />
