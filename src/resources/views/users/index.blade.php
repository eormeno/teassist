<x-event-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <div class="mt-4">
                        <x-button onclick="location.href='{{ route('users.create') }}'" class="inline-flex items-center px-4 py-2 mb-2 font-semibold text-xs disabled:opacity-25 transition ease-in-out duration-150">
                            Nuevo usuario
                        </x-button>
    ...
    <!-- Modal -->
    <div x-data="{ showModal: false, userId: null }" @open-modal.window="showModal = true; userId = $event.detail.userId">
        <template x-if="showModal">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex justify-center items-center">
                <div class="bg-white rounded-lg p-6 shadow-lg max-w-sm">
                    ...
                    <p class="mb-4">¿Estás seguro de que quieres eliminar este usuario?</p>
